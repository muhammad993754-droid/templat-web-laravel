...
<head>
    ...
    <title>@yield('title', 'AdminKit') | Laravel</title>
        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('pages.profile') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('pages.blank') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('pages.blank') }}">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('ui.buttons') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('ui.forms') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('ui.cards') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('ui.typography') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('charts.chartjs') ? 'active' : '' }}">
                ...
                <div class="sidebar-cta">
                    <div class="sidebar-cta-content">
                        ...
                        <div class="d-grid">
                            <a href="https://adminkit.io/upgrade-to-pro/" class="btn btn-primary" target="_blank" rel="noopener">Upgrade to Pro</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="navbar-nav navbar-align">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                <img src="{{ asset('img/avatars/avatar.jpg') }}" class="avatar img-fluid rounded me-1" alt="{{ auth()->user()->name ?? 'User' }}" />
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a href="https://adminkit.io/" class="text-muted" target="_blank" rel="noopener"><strong>AdminKit</strong></a> &copy;
                            </p>
                        </div>
                        <div class="col-6 text-end">
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <a href="https://adminkit.io/" class="text-muted" target="_blank" rel="noopener">Support</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="https://adminkit.io/" class="text-muted" target="_blank" rel="noopener">Help Center</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="https://adminkit.io/" class="text-muted" target="_blank" rel="noopener">Privacy</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="https://adminkit.io/" class="text-muted" target="_blank" rel="noopener">Terms</a>
                                </li>
                            </ul>
                        </div>
                    </div>
